...
class HpsfReplayReportGateTest(unittest.TestCase):
    ...
    def test_JenkinsReplayScriptArchivesReportTest(self) -> None:
        ...
        self.assertIn("string(name: 'HPSF_STAGE_A_REPLAY_STREAM_THREADS', defaultValue: '4'", pipeline)
        ...
        self.assertIn('--env=HPSF_STREAMS_NUM_STREAM_THREADS="${HPSF_STAGE_A_REPLAY_STREAM_THREADS:-4}"', pipeline)
