...
class HpsfTopicScriptTest(unittest.TestCase):
    ...
    def test_dry_run_contains_required_topics_and_rf1_config(self) -> None:
        ...
        self.assertIn("options.opra.tcbbo partitions=4", output)
        self.assertIn("options.opra.trades partitions=4", output)
        self.assertIn("options.opra.quotes partitions=4", output)
        self.assertIn("options.hpsf.strike-flow partitions=4", output)
        ...
        self.assertIn("options.ibkr.strike-flow partitions=4", output)
