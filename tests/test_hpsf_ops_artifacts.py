...
class HpsfOpsArtifactsTest(unittest.TestCase):
    ...
    def test_stage_b_runtime_smoke_produces_fixture_and_requires_fresh_outputs(self) -> None:
        ...
        self.assertIn("options.hpsf.latest-signal", text)
        self.assertIn("options.hpsf.underlying-state", text)
        self.assertIn("$trade_date|SPX", text)
        self.assertIn("spotTime", text)
        self.assertIn("esLastTime", text)
        self.assertIn("esVwapTime", text)
        self.assertIn("basisTime", text)
        self.assertIn("momentum1m", text)
        self.assertIn("momentum5m", text)
        ...
        self.assertNotIn("produce_keyed_json underlying.es.trades", text)
        self.assertNotIn("produce_keyed_json underlying.spx.price", text)
        self.assertNotIn("spotEventTime", text)
        self.assertNotIn("esLastEventTime", text)
        self.assertNotIn("esVwapEventTime", text)
        self.assertNotIn("basisUpdatedAt", text)
        self.assertNotIn("esMomentum1m", text)
        self.assertNotIn("esMomentum5m", text)
