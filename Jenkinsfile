pipeline {
  ...
  parameters {
    ...
    string(name: 'KAFKA_BOOTSTRAP_SERVERS', defaultValue: '', description: 'Kafka bootstrap servers. Empty uses host.docker.internal:9092 for dev and 192.168.100.252:9092,9094,9096 for staging/production.')
