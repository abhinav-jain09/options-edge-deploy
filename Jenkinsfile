...
pipeline {
  ...
  parameters {
    ...
    string(name: 'PERMITTED_SHA_GUARD_VERSION', defaultValue: 'c9c82413d037ded2ba80f506e0af4b28b089f46fb57021f27b76b1af954b3803',
    ...
    string(name: 'GAMMA_LADDER_PATH_IMAGE', defaultValue: '', description: 'Gamma ladder path service image (measurement only)')
      ...
      steps {
        script {
          ...
          def _defaults = [
            ...
            'GAMMA_LADDER_PATH_IMAGE': 'gamma-ladder-path',
