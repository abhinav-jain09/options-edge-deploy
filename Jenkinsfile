...
pipeline {
  ...
  parameters {
    ...
    string(name: 'ZERO_DTE_INTELLIGENCE_IMAGE', defaultValue: '', description: 'Live 0DTE volatility intelligence image')
      ...
      steps {
        script {
          ...
          def _defaults = [
            ...
            'ZERO_DTE_INTELLIGENCE_IMAGE': 'zero-dte-intelligence',
...
void promoteToProduction() {
  ...
  build job: env.JOB_NAME,
    ...
    parameters: [
      ...
      'STRIKE_LIQUIDITY_HEATMAP_IMAGE', 'UNIFIED_SR_IMAGE', 'STRIKE_INTELLIGENCE_IMAGE', 'ZERO_DTE_INTELLIGENCE_IMAGE', 'STRIKE_INVASION_IMAGE',
