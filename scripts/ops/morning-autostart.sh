...
KEEP_DOWN="${KEEP_DOWN:-hpsf-stage-a-service hpsf-stage-b-service volume-sandwich-service volume-sandwich-databento-service volume-pace-service volume-pace-databento-service strike-flow-classifier-ibkr options-edge-integration-test spx-mission-control-service short-premium-agent-service spread-skew-service spread-skew-postgres-writer dealer-ledger-service dealer-ledger-calibration-scorer option-price-behavior-service dealer-ledger-calibration-accumulator directional-pressure-databento-service databento-maxpain-service databento-mission-sandwich-service directional-pressure-service option-truth-engine-service}"
