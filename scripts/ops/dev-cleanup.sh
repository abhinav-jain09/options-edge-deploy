...
# TEMPORARY (2026-08-05, dev CPU headroom): dealer-ledger-service, unified-sr-service,
# pressure-postgres-writer, es-open-direction-service and es-open-direction-postgres-writer
...
# the capacity fix. REMOVE ALL FIVE when the overlay patches are reverted — see
# k8s/overlays/dev/dealer-ledger-dev-scale-down-patch.yaml.
DISABLED_DEV='dealer-ledger-service|unified-sr-service|pressure-postgres-writer|es-open-direction-service|es-open-direction-postgres-writer|hpsf-stage-a-service|hpsf-stage-b-service|volume-pace-service|volume-pace-databento-service|volume-sandwich-service|volume-sandwich-databento-service|databento-timewarp-snapshot-replay|strike-flow-classifier-ibkr|options-edge-integration-test|databento-mission-pressure-service|databento-mission-pace-service|spx-mission-control-service|short-premium-agent-service|spread-skew-service|spread-skew-postgres-writer|directional-pressure-databento-service|databento-maxpain-service|databento-mission-sandwich-service|directional-pressure-service|option-truth-engine-service'
