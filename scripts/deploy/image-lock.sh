...
CORRIDOR_GAUGE_IMAGE
GAMMA_LADDER_PATH_IMAGE
SPREAD_SKEW_POSTGRES_WRITER_IMAGE
ES_OPEN_DIRECTION_IMAGE
ES_OPEN_DIRECTION_POSTGRES_WRITER_IMAGE
CLOSE_DIRECTION_IMAGE
SPOT_VOL_REGIME_IMAGE
GAMMA_LEADERSHIP_IMAGE
VOL_PREMIUM_IMAGE
INDICATOR_SERVICE_IMAGE
STOCK_GEX_IMAGE
DROP_CLASSIFIER_IMAGE
OI_SHADOW_IMAGE
...
ES_AGGRESSOR_FLOW_IMAGE
ES_TRADE_LINEARIZER_IMAGE
