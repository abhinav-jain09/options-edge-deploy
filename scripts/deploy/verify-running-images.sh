...
IMAGE_MAP = {
    ...
    ("databento-mission-pace-service", "databento-mission-pace"): "DATABENTO_MISSION_PACE_IMAGE",
    ("databento-mission-pressure-service", "databento-mission-pressure"): "DATABENTO_MISSION_PRESSURE_IMAGE",
    ("databento-mission-sandwich-service", "databento-mission-sandwich"): "DATABENTO_MISSION_SANDWICH_IMAGE",
    ("volume-pace-service", "volume-pace"): "VOLUME_PACE_IMAGE",
    ...
    ("volume-sandwich-service", "volume-sandwich"): "VOLUME_SANDWICH_IMAGE",
    ("volume-sandwich-databento-service", "volume-sandwich"): "VOLUME_SANDWICH_IMAGE",
    ("unusual-whales-gex-service", "unusual-whales-gex"): "UNUSUAL_WHALES_GEX_IMAGE",
    ("unusual-whales-gex-history-service", "unusual-whales-gex-history"): "UNUSUAL_WHALES_GEX_HISTORY_IMAGE",
    ...
    ("options-edge-integration-test", "integration-test"): "INTEGRATION_TEST_IMAGE",
    ("hpsf-stage-a-service", "hpsf-stage-a"): "HPSF_PROCESSING_IMAGE",
    ("hpsf-stage-b-service", "hpsf-stage-b"): "HPSF_PROCESSING_IMAGE",
