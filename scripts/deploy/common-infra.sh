...
# (Keycloak's Deployment/StatefulSet are the sanctioned exception — it IS infra. Both instances
# qualify: `oe-keycloak*` is the internal identity provider and `bo-keycloak*` is the public one
