...
OPTION_TRUTH_ENGINE_IMAGE=$registry/options-edge-option-truth-engine:$image_tag
...
IBKR_TRADES_FEED_IMAGE=$registry/options-edge-ibkr-trades-feed:$image_tag
IBKR_TRADES_POSTGRES_WRITER_IMAGE=$registry/options-edge-ibkr-trades-postgres-writer:$image_tag
...
IBKR_TRADES_FEED_IMAGE=$IBKR_TRADES_FEED_IMAGE
IBKR_TRADES_POSTGRES_WRITER_IMAGE=$IBKR_TRADES_POSTGRES_WRITER_IMAGE
