#!/usr/bin/env bash
          ...
          for _img_var in DATABENTO_FEED_IMAGE DATABENTO_GEX_IMAGE OPTION_PRICE_BEHAVIOR_IMAGE \
            ...
            STRIKE_INVASION_IMAGE INVASION_POSTGRES_WRITER_IMAGE SPREAD_SKEW_IMAGE SPREAD_SKEW_POSTGRES_WRITER_IMAGE REVERSAL_CONFIRMATION_IMAGE ES_OPEN_DIRECTION_IMAGE ES_OPEN_DIRECTION_POSTGRES_WRITER_IMAGE CLOSE_DIRECTION_IMAGE SPOT_VOL_REGIME_IMAGE INDICATOR_SERVICE_IMAGE DROP_CLASSIFIER_IMAGE OI_SHADOW_IMAGE REVERSAL_POSTGRES_WRITER_IMAGE GREEK_MOVE_AUTHENTICITY_IMAGE; do
