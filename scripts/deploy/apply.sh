#!/usr/bin/env bash
          ...
          for _img_var in DATABENTO_FEED_IMAGE DATABENTO_GEX_IMAGE OPTION_PRICE_BEHAVIOR_IMAGE \
            ...
            DIRECTIONAL_PRESSURE_IMAGE FEED_GATEWAY_IMAGE \
            ...
            STRIKE_INVASION_IMAGE INVASION_POSTGRES_WRITER_IMAGE SPREAD_SKEW_IMAGE SPREAD_SKEW_POSTGRES_WRITER_IMAGE REVERSAL_CONFIRMATION_IMAGE CORRIDOR_GAUGE_IMAGE GAMMA_LADDER_PATH_IMAGE ES_OPEN_DIRECTION_IMAGE ES_OPEN_DIRECTION_POSTGRES_WRITER_IMAGE CLOSE_DIRECTION_IMAGE SPOT_VOL_REGIME_IMAGE GAMMA_LEADERSHIP_IMAGE VOL_PREMIUM_IMAGE INDICATOR_SERVICE_IMAGE STOCK_GEX_IMAGE DROP_CLASSIFIER_IMAGE OI_SHADOW_IMAGE REVERSAL_POSTGRES_WRITER_IMAGE GREEK_MOVE_AUTHENTICITY_IMAGE NIFTY_GEX_IMAGE; do
...
EOF
          ...
          kubectl -n options-edge set image deployment/nifty-gex-service nifty-gex="$NIFTY_GEX_IMAGE"
